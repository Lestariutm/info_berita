<div class="row">
                ...
                <form action="<?php echo base_url('index.php/Admin_pendidikan/update'); ?>" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $query->pendidikan_id; ?>">
